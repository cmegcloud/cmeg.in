...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        console.warn("Component fetch skipped.");
    }
        ...
        if (summaryBarCanvasTarget) {
            ...
            new Chart(ctxBarInstance, {
                ...
                data: {
                    ...
                    datasets: [
                        { label: 'Sales', data: [150000, 180000, 140000, 220000, 190000, 260000, 310000, 280000, 340000, 380000, 420000, 480000], backgroundColor: salesGradient, borderRadius: 6, barPercentage: 0.5 },
                        { label: 'Purchase', data: [110000, 140000, 100000, 180000, 150000, 210000, 250000, 230000, 280000, 310000, 340000, 390000], backgroundColor: purchaseGradient, borderRadius: 6, barPercentage: 0.5 }
                    ]
                },
                options: {
                    responsive: true, maintainAspectRatio: false,
                    scales: { y: { beginAtZero: true, grid: { color: '#f1f5f9' }, ticks: { color: '#64748b' } }, x: { grid: { display: false }, ticks: { color: '#475569' } } },
                    plugins: { legend: { position: 'top', align: 'end', labels: { color: '#0f172a', usePointStyle: true, pointStyle: 'circle' } } }
                }
            });
        }
    } catch(e) {}
